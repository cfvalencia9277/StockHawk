...
import com.sam_chordas.android.stockhawk.adapters.CustomSpinnerAdapter;
import com.sam_chordas.android.stockhawk.fragments.LineChartFragment;
...
public class DetailActivity  extends AppCompatActivity implements Callback<QuoteInfo> {
    ...
    private void fetchStockDetails(String symbol, String startDate, String endDate) {
        ...
        //http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20yahoo.finance.historicaldata%20where%20symbol%20=%20%22YHOO%22%20and%20startDate%20=%20%222014-02-
        // 11%22%20and%20endDate%20=%20%222014-02-18%22&format=json&diagnostics=true&env=store://datatables.org/alltableswithkeys&callback=
        ...
        Log.d("hello" , "i m in fetchStockdetail");
